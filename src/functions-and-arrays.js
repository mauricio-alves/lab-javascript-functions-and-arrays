...
function findLongestWord(param) {
  ...
  if (!param.length) {
    ...
    let longestWord = param.sort(function (a, b) {
...
function averageNumbers(param) {
  ...
  if (!param.length) {
    ...
    result = param.reduce((a, b) => a + b, 0) / param.length;
  }
  return result;
}
...
function doesWordExist(param1, param2) {
  ...
  if (!param1.length) {
    ...
    includesOrNot = param1.includes(param2) ? true : false;
  }
